Public Class class_placeholder4
    ...
    Public Function blank_textbox() As Boolean
        If t.Text.ToUpper = cPlaceholder.ToUpper Or t.Text.ToUpper = "" Then
            blank_textbox = True
    ...
    Public Function blank_combobox() As Boolean
        If cCombobox.Text.ToUpper = cPlaceholder.ToUpper Then
            blank_combobox = True
            MessageBox.Show("combobox '" & cPlaceholder & "' must not be blank...", "SUPPLY INFO:", MessageBoxButtons.OK, MessageBoxIcon.Stop)
            cCombobox.Focus()
        End If
    ...
    Public Sub resetComboBoxFields()
