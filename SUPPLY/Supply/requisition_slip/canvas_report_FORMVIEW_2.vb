Public Class canvas_report_FORMVIEW_2
    Private Sub canvas_report_FORMVIEW_2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim cs_no(0) As Microsoft.Reporting.WinForms.ReportParameter
        cs_no(0) = New Microsoft.Reporting.WinForms.ReportParameter("cs_no", Canvas_Report_req.TextBox6.Text.ToString)
        ReportViewer1.LocalReport.SetParameters(cs_no)


        Dim rsNo(0) As Microsoft.Reporting.WinForms.ReportParameter
        rsNo(0) = New Microsoft.Reporting.WinForms.ReportParameter("rsNo", Canvas_Report_req.rsNo.Text.ToString)
        ReportViewer1.LocalReport.SetParameters(rsNo)
