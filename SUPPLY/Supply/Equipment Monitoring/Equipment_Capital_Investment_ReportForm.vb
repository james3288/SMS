Public Class Equipment_Capital_Investment_ReportForm
    Private Sub Equipment_Capital_Investment_ReportForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        EquipmentType(0) = New Microsoft.Reporting.WinForms.ReportParameter("EquipmentType", FEquipment_monitoring.cmb_search_equiptype.Text.ToString)
        ...
        DatePeriod(0) = New Microsoft.Reporting.WinForms.ReportParameter("DatePeriod", FEquipment_monitoring.Label19.Text.ToString)
