Public Class EquipmentQuarterlyIncomeFormReport
    Private Sub EquipmentQuarterlyIncomeFormReport_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim date_format_par(0) As Microsoft.Reporting.WinForms.ReportParameter
        date_format_par(0) = New Microsoft.Reporting.WinForms.ReportParameter("date_format_par", FIncome_statement.Label21.Text.ToString)
        ReportViewer1.LocalReport.SetParameters(date_format_par)
