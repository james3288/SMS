...
Public Class CreateWithdrawalForDrServices
    ...
    Public Function ExecuteWithdraw(rs_id As Integer, ws_id As Integer) As Integer
        Try
            Dim CREATEWSFORDR As New CreateWithdrawalSlipForDrModel

            Dim withdrawn_id As Integer = CREATEWSFORDR.withdraw_aggregates(rs_id, ws_id)
            Return withdrawn_id
